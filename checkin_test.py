...
def test_checkin(m):
    m.register_uri('GET', '/api/mobile-air-booking/v1/mobile-air-booking/page/view-reservation/XXXX?first-name=John&last-name=Smith', text=open('fixtures/view-reservation.json', 'r').read())
